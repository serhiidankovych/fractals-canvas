...
const KochSnowflake = ({ initialWidth, recursionDepth }) => {
  ...
  useEffect(() => {
    ...
    ctx.translate((canvas.width - initialWidth) / 2, canvas.height / 1.7); // Translate to center
...
export default KochSnowflake; // Export KochSnowflake component
